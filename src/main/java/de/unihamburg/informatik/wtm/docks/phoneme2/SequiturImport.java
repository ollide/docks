 ...
 * if these were part of the training material.
 * If in doubt, please check for and replace them in the alphabet portion of 
 * the XML prior to using this converter. 
 * 
 * Implementation details:
 * - we add a state for &lt;s&gt; to the end of both symbol alphabets
 * - we increment all state IDs in the states and in the arcs
 * - we add a new zero'th state which transitions via &lt;s&gt;:&lt;s&gt; to the (new) first state
 * 
...
//		System.err.println(path);
	...
	public static void importSequitur(String input, String output) throws JAXBException, IOException
	{
		...
		System.out.println("The Sequitur G2P XML-formatted FST " + input + " has been converted to Sphinx' OpenFst binary format in the file " + output);
	}
}
